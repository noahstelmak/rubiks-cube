...
export function rubiksBuilder(size) {
    ...
    for (let i = 0; i < 27; i++) {
        ...
        const rubiks_piece = buildRubiksPiece(vector, size);
...
function buildRubiksPiece(vector, size) {
    const [x, y, z] = vector;
    ...
    for (let axis = 0; axis <= 2; axis++) {
        ...
        const rubiks_face = buildRubiksFace(axis, direction, size);
...
function buildRubiksFace(axis, direction, size) {
